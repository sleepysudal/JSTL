...
<body>
	...
	<!-- <h3>list에는 총 ${requestScope.totalCount }개의 색상이 들어있다</h3> 달러{변수명}일 경우requestScope가 생략된 것임
	request에 저장된데이터는 자바처럼 getAttribute로 얻지않아도 바로 출력가능하다 하지만 세션은 sessionScope 를 생략하지 않는다-->
	
	<h3>세션아이디 출력</h3>
	<h4>현재 로그인한 아이디는 ${id }입니다</h4>
